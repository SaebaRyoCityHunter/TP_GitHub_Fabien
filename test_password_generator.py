import unittest # Importation de l'environement de test Unittest #
...
class TestPasswordGenerator(unittest.TestCase):
    def test_password_length(self): # vérifie que la longueur du mot de passe généré correspond à la longueur demandée #
        ...
        passwords = generatePassword(password_lenghts) # Définitions des variables #
        for i, password in enumerate(passwords): # Pour chaque génération de mdp #
